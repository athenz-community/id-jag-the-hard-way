...
- The MCP container mounts only the published identity Secret, read-only, at `/var/run/athenz/service.cert.pem` and `/var/run/athenz/service.key.pem`.
