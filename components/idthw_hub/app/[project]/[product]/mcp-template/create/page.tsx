...
export default async function CreateMcpTemplateRoute({
  params,
}: {
  ...
  return (
    <ConsoleTemplate>
      ...
      <div className="mcp-create-layout">
        <McpTemplateCreateSteps activeStep="source" sourceHref={createHref} configurationHref={configurationHref} />
        <SourceForm cancelHref={templateHref} configurationHref={configurationHref} />
      </div>
    </ConsoleTemplate>
  )
}
